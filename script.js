document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        function showError(field, message) {
            ...
            const dir = getComputedStyle(field).direction || document.documentElement.dir || 'ltr';
            errorEl.style.direction = dir;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '5bcdb72d-9615-4fdc-9096-ac3e6fd89587',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '5bcdb72d-9615-4fdc-9096-ac3e6fd89587';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '5bcdb72d-9615-4fdc-9096-ac3e6fd89587';
